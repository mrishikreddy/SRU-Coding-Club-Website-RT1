          ...
          <div className={styles.actions}>
            {userLoggedIn ? (
              <div className={styles.userMenu}>
                <div className={styles.userIcon} onClick={() => setMenuOpen(!menuOpen)}>👤</div>
                {menuOpen && (
                    ...
                    {combinedUserData ? (
                      <>
                        ...
                        <div className={styles.details}>
                          <div className={styles.detailsChild}>Name: {combinedUserData.Name}</div>
                          <div className={styles.detailsChild}>Hall Ticket No: {combinedUserData.HTNO.toUpperCase()}</div>
                          <div className={styles.detailsChild}>Year: {combinedUserData.Year}</div>
                          <div className={styles.detailsChild}>Points: {combinedUserData.Points}</div>
                        </div>
