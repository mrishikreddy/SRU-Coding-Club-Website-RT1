...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    const email = `${hallTicket.trim()}@sru.edu.in`;
    ...
    try {
      ...
      if (!user.emailVerified) {
        ...
        setErrorMessage("Verification email sent to your college email. Please verify it before logging in. Don’t forget to check your spam folder");
          ...
          <div className={styles.inputOuterDiv}>
            <div className={styles.inputContainer}>
              <input
                ...
                type="text"
                placeholder="Enter SRU Hall Ticket Number"
                value={hallTicket}
